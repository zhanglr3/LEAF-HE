...
vector<Plaintext> ecd_dcd_matrix_slow(int degree, const vector<vector<uint64_t>>& dcdmatrix, 
...
extern Ciphertext Slot_to_coeff_slow(const Ciphertext & RLWE_ct, const vector<Plaintext> & M, 
